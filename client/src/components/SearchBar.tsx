  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-full">
      ...
      <input
        ...
        autoFocus={autoFocus}
        className={`font-cormorant w-full rounded-none border bg-[var(--bg-surface)] text-[var(--text-primary)] placeholder:italic placeholder:text-[var(--text-dim)] outline-none transition duration-200 ${
