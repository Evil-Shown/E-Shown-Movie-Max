...
export const LIVE_TV_CHANNELS: LiveTvChannel[] = [
  ...
  channel("ada-derana-24", "Ada Derana 24x7", "local", {
    ...
    logoColor: "#dc2626",
    description: "24-hour Sinhala news from Derana Macro Entertainment.",
  }),
  channel("jaya-tv", "Jaya TV", "local", { logoColor: "#2563eb" }),
  channel("shraddha-tv", "Shraddha TV", "local", { logoColor: "#ca8a04", description: "Buddhist religious channel." }),
  channel("charana-tv", "Charana TV", "local", { logoColor: "#7c3aed" }),
  channel("the-buddhist", "The Buddhist", "local", { logoColor: "#f59e0b", description: "Buddhist teachings and programmes." }),
  channel("tv1", "TV 1", "local", { logoColor: "#0891b2" }),
  channel("art-tv", "ART Television", "local", { logoColor: "#6366f1" }),
  channel("rangiri-tv", "Rangiri TV", "local", { logoColor: "#16a34a" }),
  channel("haritha-tv", "Haritha TV", "local", { logoColor: "#15803d" }),
  channel("tv-didula", "TV Didula", "local", { logoColor: "#0d9488" }),
  channel("damsathara-tv", "Damsathara TV", "local", { logoColor: "#b45309" }),
