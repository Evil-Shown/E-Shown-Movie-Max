...
export default function NotFound() {
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-4 py-24 text-center">
      ...
      <p className="font-[var(--font-playfair)] gradient-hue-rotate text-[10rem] font-bold leading-none sm:text-[15rem]">
        404
      </p>
      <h1 className="mt-4 font-[var(--font-playfair)] text-3xl italic text-[var(--text-primary)]">
